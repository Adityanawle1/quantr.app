...
export default function PEChart({ symbol }: { symbol: string }) {
  ...
  return (
    <div className="bg-navy-card/50 rounded-2xl border border-[rgba(255,255,255,0.06)] p-6 flex flex-col h-full w-full min-h-[300px]">
      <h3 className="text-xl font-bold text-t1 font-jakarta mb-6">P/E History</h3>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={history} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(val: any) => [Number(val).toFixed(2), 'P/E']}
            />
            ...
            <Area type="monotone" dataKey="pe" stroke="#3FD68C" strokeWidth={3} fill="url(#peGrad)" activeDot={{ r: 6, fill: '#3FD68C', stroke: '#131B28', strokeWidth: 2 }} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
